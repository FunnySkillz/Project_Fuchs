  ...
  it("uses localized template labels from the document model", () => {
    ...
    model.labels = {
      ...
      sections: {
        ...
        nonImageAttachments: "Nicht-Bild Anhänge",
      },
      detail: {
      ...
      appendix: {
        ...
        noImageAttachments: "Keine Bildanhänge gefunden.",
        noImageAttachmentsInItem: "Keine Bildanhänge verfügbar.",
        noNonImageAttachments: "Keine Nicht-Bild Anhänge.",
      },
      nonImageTable: {
        item: "Eintrag",
        file: "Datei",
      ...
      attachment: {
        statusMissing: "fehlt",
        statusPreviewUnavailable: "Vorschau nicht verfügbar",
        statusOk: "ok",
        placeholderImageMissing: "Bilddatei fehlt",
        placeholderPreviewUnavailable: "Vorschau nicht verfügbar",
        placeholderNoImageAttachment: "Kein Bildanhang",
        placeholderNoImagePreviewForItem: "Keine Bildvorschau für diesen Eintrag.",
        noAttachments: "Keine Anhänge",
        noFilesLinked: "Keine Dateien verknüpft.",
      },
    };
