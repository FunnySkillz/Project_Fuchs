...
CREATE TABLE IF NOT EXISTS ProfileSettings (
  ...
  MonthlyGrossIncomeCents INTEGER NOT NULL DEFAULT 0,
  SalaryPaymentsPerYear INTEGER NOT NULL DEFAULT 14,
  UseManualMarginalTaxRate INTEGER NOT NULL DEFAULT 0,
  ManualMarginalRateBps INTEGER NOT NULL DEFAULT 4000,
  DefaultWorkPercent INTEGER NOT NULL,
  GwgThresholdCents INTEGER NOT NULL,
  ApplyHalfYearRule INTEGER NOT NULL,
  WerbungskostenPauschaleEnabled INTEGER NOT NULL DEFAULT 1,
  WerbungskostenPauschaleAmountCents INTEGER NOT NULL DEFAULT 13200,
